/** biome-ignore-all lint/security/noDangerouslySetInnerHtml: TODO: investigate if `dangerouslySetInnerHTML` can be replaced */
export const InstructionsSection = ({ showInstructions, setShowInstructions, t }) => {
  return (
    <div className="mb-5 text-center">
      ...
      {showInstructions && (
        <div className="instructions-content bg-white border-2 border-black p-5 mt-4 text-left max-w-4xl mx-auto font-typewriter rounded-md shadow-sm">
          <h4 className="text-black mb-4 text-lg text-center uppercase tracking-wide">{t('instructionsTitle')}</h4>
